...
public class JFrameMostrarUbicacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 110, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameMostrarUbicacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameMostrarUbicacion().setVisible(true);
            }
        });
    }
